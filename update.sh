...
show_banner() {
    ...
    printf "${AMBER}${BOLD}  ║${RST}${AMBER_BRIGHT}${BOLD}                                                              ${RST}${AMBER}${BOLD}║${RST}\n"
    printf "${AMBER}${BOLD}  ║${RST}     ${AMBER_BRIGHT}${BOLD}   ██████╗██╗███╗   ██╗██████╗ ${RST}                               ${AMBER}${BOLD}║${RST}\n"
    printf "${AMBER}${BOLD}  ║${RST}     ${AMBER_BRIGHT}${BOLD}  ██╔════╝██║████╗  ██║██╔══██╗${RST}                               ${AMBER}${BOLD}║${RST}\n"
    printf "${AMBER}${BOLD}  ║${RST}     ${AMBER_BRIGHT}${BOLD}  ██║     ██║██╔██╗ ██║██║  ██║${RST}    ${GOLD}${BOLD}U P D A T E${RST}                      ${AMBER}${BOLD}║${RST}\n"
    printf "${AMBER}${BOLD}  ║${RST}     ${AMBER_BRIGHT}${BOLD}  ██║     ██║██║╚██╗██║██║  ██║${RST}                               ${AMBER}${BOLD}║${RST}\n"
    printf "${AMBER}${BOLD}  ║${RST}     ${AMBER_BRIGHT}${BOLD}  ╚██████╗██║██║ ╚████║██████╔╝${RST}                               ${AMBER}${BOLD}║${RST}\n"
    printf "${AMBER}${BOLD}  ║${RST}     ${AMBER_BRIGHT}${BOLD}   ╚═════╝╚═╝╚═╝  ╚═══╝╚═════╝ ${RST}                               ${AMBER}${BOLD}║${RST}\n"
    printf "${AMBER}${BOLD}  ║${RST}                                                              ${AMBER}${BOLD}║${RST}\n"
    printf "${AMBER}${BOLD}  ║${RST}  ${DIM}Movie Streaming — Update Utility${RST}                              ${AMBER}${BOLD}║${RST}\n"
    printf "${AMBER}${BOLD}  ║${RST}                                                              ${AMBER}${BOLD}║${RST}\n"
    printf "${AMBER}${BOLD}  ╚══════════════════════════════════════════════════════════════╝${RST}\n"
    printf "\n"
}
